public class Main {
  public static void main(String[] args) {
    ...
    long elapsedTime = endTimeBest - startTimeBest;
    System.out.println("Best-case elapsed time: "+ elapsedTime);  
    if (index >= 0)
    ...
    // * Calculate elapsedTime here
    elapsedTime = endTimeWorst - startTimeWorst;
    System.out.println("Worst-case elapsed time: "+ elapsedTime);  
    if (index >= 0)
